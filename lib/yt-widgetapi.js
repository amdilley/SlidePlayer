...
c.prototype=b.prototype;a.K=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.base=function(a,c,f){for(var k=Array(arguments.length-2),m=2;m<arguments.length;m++)k[m-2]=arguments[m];return b.prototype[c].apply(a,k)}}
...
if("undefined"!==typeof a&&!B("Trident")&&!B("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(void 0!==c.next){c=c.next;var a=c.M;c.M=null;a()}};
return function(a){d.next={M:a};d=d.next;b.port2.postMessage(0)}}return"undefined"!==typeof document&&"onreadystatechange"in document.createElement("SCRIPT")?function(a){var b=document.createElement("SCRIPT");
...
G.prototype.dispose=function(){this.h||(this.h=!0,this.H())};
G.prototype.H=function(){if(this.j)for(;this.j.length;)this.j.shift()()};function H(a){G.call(this);this.w=1;this.l=[];this.m=0;this.c=[];this.f={};this.F=!!a}
v(H,G);g=H.prototype;g.subscribe=function(a,b,c){var d=this.f[a];d||(d=this.f[a]=[]);var e=this.w;this.c[e]=a;this.c[e+1]=b;this.c[e+2]=c;this.w=e+3;d.push(e);return e};
function Ya(a,b,c){var d=K;if(a=d.f[a]){var e=d.c;(a=pa(a,function(a){return e[a+1]==b&&e[a+2]==c}))&&d.L(a)}}
g.L=function(a){var b=this.c[a];if(b){var c=this.f[b];if(0!=this.m)this.l.push(a),this.c[a+1]=aa;else{if(c){var d=oa(c,a);0<=d&&Array.prototype.splice.call(c,d,1)}delete this.c[a];delete this.c[a+1];delete this.c[a+2]}}return!!b};
g.O=function(a,b){var c=this.f[a];if(c){for(var d=Array(arguments.length-1),e=1,f=arguments.length;e<f;e++)d[e-1]=arguments[e];if(this.F)for(e=0;e<c.length;e++){var k=c[e];Za(this.c[k+1],this.c[k+2],d)}else{this.m++;try{for(e=0,f=c.length;e<f;e++)k=c[e],this.c[k+1].apply(this.c[k+2],d)}finally{if(this.m--,0<this.l.length&&0==this.m)for(;c=this.l.pop();)this.L(c)}}return 0!=e}return!1};
function Za(a,b,c){Ta(function(){a.apply(b,c)})}
g.clear=function(a){if(a){var b=this.f[a];b&&(x(b,this.L,this),delete this.f[a])}else this.c.length=0,this.f={}};
g.H=function(){H.K.H.call(this);this.clear();this.l.length=0};var $a=/^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#(.*))?$/;function ab(a,b,c){if("array"==n(b))for(var d=0;d<b.length;d++)ab(a,String(b[d]),c);else null!=b&&c.push("&",a,""===b?"":"=",encodeURIComponent(String(b)))}
...
;function M(a){this.type="";this.source=this.data=this.currentTarget=this.relatedTarget=this.target=null;this.charCode=this.keyCode=0;this.shiftKey=this.ctrlKey=this.altKey=!1;this.clientY=this.clientX=0;if(a=a||window.event){this.c=a;for(var b in a)b in lb||(this[b]=a[b]);(b=a.target||a.srcElement)&&3==b.nodeType&&(b=b.parentNode);this.target=b;if(b=a.relatedTarget)try{b=b.nodeName?b:null}catch(c){b=null}else"mouseover"==this.type?b=a.fromElement:"mouseout"==this.type&&(b=a.toElement);this.relatedTarget=
b;this.clientX=void 0!=a.clientX?a.clientX:a.pageX;this.clientY=void 0!=a.clientY?a.clientY:a.pageY;this.keyCode=a.keyCode?a.keyCode:a.which;this.charCode=a.charCode||("keypress"==this.type?this.keyCode:0);this.altKey=a.altKey;this.ctrlKey=a.ctrlKey;this.shiftKey=a.shiftKey}}
M.prototype.preventDefault=function(){this.c&&(this.c.returnValue=!1,this.c.preventDefault&&this.c.preventDefault())};
M.prototype.stopPropagation=function(){this.c&&(this.c.cancelBubble=!0,this.c.stopPropagation&&this.c.stopPropagation())};
M.prototype.stopImmediatePropagation=function(){this.c&&(this.c.cancelBubble=!0,this.c.stopImmediatePropagation&&this.c.stopImmediatePropagation())};
...
function zb(a,b){K.O.apply(K,arguments)}
;function P(a,b,c){this.f=b;this.l=this.c=null;this.m=this[r]||(this[r]=++ca);this.h=0;this.I=!1;this.G=[];this.j=null;this.w=c;this.F={};b=document;if(a=q(a)?b.getElementById(a):a)if("iframe"!=a.tagName.toLowerCase()&&(b=Ab(this,a),this.l=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.c=a,this.c.id||(b=a=this.c,b=b[r]||(b[r]=++ca),a.id="widget"+b),N[this.c.id]=this,window.postMessage){this.j=new H;Bb(this);a=Q(this.f,"events");for(var d in a)a.hasOwnProperty(d)&&this.addEventListener(d,a[d]);for(var e in wb)Cb(this,
e)}}
g=P.prototype;g.Y=function(a,b){this.c.width=a;this.c.height=b;return this};
g.X=function(){return this.c};
g.P=function(a){this.v(a.event,a)};
g.addEventListener=function(a,b){var c=b;"string"==typeof b&&(c=function(){window[b].apply(window,arguments)});
this.j.subscribe(a,c);Db(this,a);return this};
function Cb(a,b){var c=b.split(".");if(2==c.length){var d=c[1];a.w==c[0]&&Db(a,d)}}
g.W=function(){this.c.id&&(N[this.c.id]=null);var a=this.j;a&&"function"==typeof a.dispose&&a.dispose();if(this.l){var a=this.c,b=a.parentNode;b&&b.replaceChild(this.l,a)}else(a=this.c)&&a.parentNode&&a.parentNode.removeChild(a);R&&(R[this.m]=null);this.f=null;var a=this.c,c;for(c in z)z[c][0]==a&&sb(c);this.l=this.c=null};
g.B=function(){return{}};
function S(a,b,c){c=c||[];c=Array.prototype.slice.call(c);b={event:"command",func:b,args:c};a.I?a.J(b):a.G.push(b)}
g.v=function(a,b){if(!this.j.isDisposed()){var c={target:this,data:b};this.j.O(a,c);zb(this.w+"."+a,c)}};
function Ab(a,b){for(var c=document.createElement("iframe"),d=b.attributes,e=0,f=d.length;e<f;e++){var k=d[e].value;null!=k&&""!=k&&"null"!=k&&c.setAttribute(d[e].name,k)}c.setAttribute("frameBorder",0);c.setAttribute("allowfullscreen",1);c.setAttribute("title","YouTube "+Q(a.f,"title"));(d=Q(a.f,"width"))&&c.setAttribute("width",d);(d=Q(a.f,"height"))&&c.setAttribute("height",d);var m=a.B();m.enablejsapi=window.postMessage?1:0;window.location.host&&(m.origin=window.location.protocol+"//"+window.location.host);
...
c.src=Q(a.f,"host")+a.C()+"?"+bb(m);return c}
g.N=function(){this.c&&this.c.contentWindow?this.J({event:"listening"}):window.clearInterval(this.h)};
function Bb(a){Eb(a.f,a,a.m);a.h=ib(t(a.N,a));rb(a.c,"load",t(function(){window.clearInterval(this.h);this.h=ib(t(this.N,this))},a))}
function Db(a,b){a.F[b]||(a.F[b]=!0,S(a,"addEventListener",[b]))}
g.J=function(a){a.id=this.m;a=La(a);var b;b=this.f;var c,d=this.c.src.match($a);c=d[1];var e=d[2],f=d[3],d=d[4],k="";c&&(k+=c+":");f&&(k+="//",e&&(k+=e+"@"),k+=f,d&&(k+=":"+d));c=k;b=0==c.indexOf("https:")?[c]:b.f?[c.replace("http:","https:")]:b.j?[c]:[c,c.replace("http:","https:")];for(c=0;c<b.length;c++)try{this.c.contentWindow.postMessage(a,b[c])}catch(m){if(m.name&&"SyntaxError"==m.name)kb(m,"WARNING");else throw m;}};var T="StopIteration"in h?h.StopIteration:{message:"StopIteration",stack:""};function U(){}
U.prototype.next=function(){throw T;};
U.prototype.A=function(){return this};
function Fb(a){if(a instanceof U)return a;if("function"==typeof a.A)return a.A(!1);if(p(a)){var b=0,c=new U;c.next=function(){for(;;){if(b>=a.length)throw T;if(b in a)return a[b++];b++}};
...
;function Ib(){}
;function Jb(){}
v(Jb,Ib);Jb.prototype.clear=function(){var a=Hb(this.A(!0)),b=this;x(a,function(a){b.remove(a)})};function V(a){this.c=a}
...
g.A=function(a){var b=0,c=this.c,d=new U;d.next=function(){if(b>=c.length)throw T;var d=c.key(b++);if(a)return d;d=c.getItem(d);if(!q(d))throw"Storage mechanism: Invalid value was encountered";return d};
return d};
...
W.prototype.l=function(a){if(a.origin==Q(this,"host")){var b;try{b=Ka(a.data)}catch(c){return}this.j=!0;this.f||0!=a.origin.indexOf("https:")||(this.f=!0);if(a=R[b.id])a.I=!0,a.I&&(x(a.G,a.J,a),a.G.length=0),a.P(b)}};function Ob(a){W.call(this,a);this.c.title="video player";this.c.videoId="";this.c.width=640;this.c.height=360}
v(Ob,W);function X(a,b){var c=new Ob(b);P.call(this,a,c,"player");this.o={};this.D={}}
...
g=X.prototype;g.C=function(){return"/embed/"+Q(this.f,"videoId")};
g.B=function(){var a=Q(this.f,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));return a};
g.P=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(ba(a))for(var c in a)this.o[c]=a[c];break;case "infoDelivery":Qb(this,a);break;case "initialDelivery":window.clearInterval(this.h);this.D={};this.o={};Rb(this,a.apiInterface);Qb(this,a);break;default:this.v(b,a)}};
function Qb(a,b){if(ba(b))for(var c in b)a.D[c]=b[c]}
function Rb(a,b){x(b,function(a){this[a]||(Mb(a)?this[a]=function(){this.D={};this.o={};S(this,a,arguments);return this}:Nb(a)?this[a]=function(){var b=0;
0==a.search("get")?b=3:0==a.search("is")&&(b=2);return this.D[a.charAt(b).toLowerCase()+a.substr(b+1)]}:this[a]=function(){S(this,a,arguments);
return this})},a)}
g.aa=function(){var a='<iframe width="'+Q(this.f,"width")+'" height="'+Q(this.f,"height")+'" src="';var b=Q(this.f,"host")+this.C();na.test(b)&&(-1!=b.indexOf("&")&&(b=b.replace(ga,"&amp;")),-1!=b.indexOf("<")&&(b=b.replace(ha,"&lt;")),-1!=b.indexOf(">")&&(b=b.replace(ia,"&gt;")),-1!=b.indexOf('"')&&(b=b.replace(ka,"&quot;")),-1!=b.indexOf("'")&&(b=b.replace(la,"&#39;")),-1!=b.indexOf("\x00")&&(b=b.replace(ma,"&#0;")));return a+b+'" frameborder="0" allowfullscreen></iframe>'};
g.$=function(a){return this.o.namespaces?a?this.o[a].options||[]:this.o.namespaces||[]:[]};
g.Z=function(a,b){if(this.o.namespaces&&a&&b)return this.o[a][b]};function Sb(a){W.call(this,a);this.c.title="Thumbnail";this.c.videoId="";this.c.width=120;this.c.height=68}
...
Y.prototype.C=function(){return"/embed/"+Q(this.f,"videoId")};
Y.prototype.B=function(){return{player:0,thumb_width:Q(this.f,"thumbWidth"),thumb_height:Q(this.f,"thumbHeight"),thumb_align:Q(this.f,"thumbAlign")}};
Y.prototype.v=function(a,b){Y.K.v.call(this,a,b?b.info:void 0)};function Ub(a){W.call(this,a);this.c.host="https://www.youtube.com";this.c.title="upload widget";this.c.width=640;this.c.height=.67*Q(this,"width")}
v(Ub,W);function Z(a,b){var c=new Ub(b);P.call(this,a,c,"upload")}
v(Z,P);g=Z.prototype;g.C=function(){return"/upload_embed"};
g.B=function(){var a={},b=Q(this.f,"webcamOnly");null!=b&&(a.webcam_only=b);return a};
g.v=function(a,b){Z.K.v.call(this,a,b);"onApiReady"==a&&S(this,"hostWindowReady")};
g.R=function(a){S(this,"setVideoDescription",arguments)};
g.T=function(a){S(this,"setVideoKeywords",arguments)};
g.U=function(a){S(this,"setVideoPrivacy",arguments)};
g.S=function(a){S(this,"setVideoDraftPrivacy",arguments)};
g.V=function(a){S(this,"setVideoTitle",arguments)};u("YT.PlayerState.UNSTARTED",-1);u("YT.PlayerState.ENDED",0);u("YT.PlayerState.PLAYING",1);u("YT.PlayerState.PAUSED",2);u("YT.PlayerState.BUFFERING",3);u("YT.PlayerState.CUED",5);u("YT.UploadWidgetEvent.API_READY","onApiReady");u("YT.UploadWidgetEvent.UPLOAD_SUCCESS","onUploadSuccess");u("YT.UploadWidgetEvent.PROCESSING_COMPLETE","onProcessingComplete");u("YT.UploadWidgetEvent.STATE_CHANGE","onStateChange");u("YT.UploadWidgetState.IDLE",0);u("YT.UploadWidgetState.PENDING",1);
